 ...
 */
public class NET_ALARM_USER extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 用户编号
	 */
	 ...
	 * 保留字节
	 */
    public byte[]           byReserved = new byte[256 - com.hikvision.nvr.dahua.lib.NetSDKLib.POINTERSIZE];
}
