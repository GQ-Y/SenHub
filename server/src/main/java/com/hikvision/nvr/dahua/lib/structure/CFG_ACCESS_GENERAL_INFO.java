...
import static com.hikvision.nvr.dahua.lib.constant.SDKStructureFieldLenth.MAX_ADDRESS_LEN;
import static com.hikvision.nvr.dahua.lib.constant.SDKStructureFieldLenth.MAX_PASSWORD_LEN;
 ...
 * @date 2021/2/7
 */
public class CFG_ACCESS_GENERAL_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
  /** 开门音频文件路径 */
  ...
  /** 保留字节 */
    public byte[]           szReserved = new byte[696-com.hikvision.nvr.dahua.lib.NetSDKLib.POINTERSIZE];
