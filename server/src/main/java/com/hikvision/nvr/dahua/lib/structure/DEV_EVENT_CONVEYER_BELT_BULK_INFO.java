...
*/
public class DEV_EVENT_CONVEYER_BELT_BULK_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 规则检测线,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] stuDetectLine = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
     * 事件ID
    */
    public int              nEventID;
    ...
    */
    ...
    /**
     * 检测到的物体信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MSG_OBJECT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MSG_OBJECT[] stuObjects = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MSG_OBJECT[20];
    /**
     * 全景广角图信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO_EX}
    */
    ...
    */
    ...
    public DEV_EVENT_CONVEYER_BELT_BULK_INFO() {
        for(int i = 0; i < stuDetectLine.length; i++){
            stuDetectLine[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
