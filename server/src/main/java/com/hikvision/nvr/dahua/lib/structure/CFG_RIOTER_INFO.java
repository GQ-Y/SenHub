...
*/
public class CFG_RIOTER_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 检测区域,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    ...
    */
    ...
    /**
     * 最小聚集区域矩形框，分别对应矩形框的左上和右下点，矩形框的实际面积表示触发报警的最小人群聚集面积,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_POLYGON[] stuMinDetectRect = new com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_POLYGON[2];
    /**
    ...
    */
    ...
    public CFG_RIOTER_INFO() {
        ...
        for(int i = 0; i < stuMinDetectRect.length; i++){
            stuMinDetectRect[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_POLYGON();
        }
