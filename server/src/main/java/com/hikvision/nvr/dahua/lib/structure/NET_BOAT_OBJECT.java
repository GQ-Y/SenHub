 ...
 */
public class NET_BOAT_OBJECT extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 ...
	 * 包围盒(绝对坐标)
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RECT stuOriginalBoundingBox = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RECT();
	/**
