 ...
 * @date 2021/10/29
 */
public class NET_CTRL_SET_BYPASS extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
     * 结构体大小
     */
    public int              dwSize;
	...
	/**
     * 通道状态,参考枚举 { @link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_BYPASS_MODE}
     */
    public int              emMode;
    /**
     * 本地报警输入通道个数
