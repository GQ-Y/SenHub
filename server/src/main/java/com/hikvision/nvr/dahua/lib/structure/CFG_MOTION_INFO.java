 ...
 *     com.netsdk.lib.NetSDKLib#CLIENT_GetNewDevConfig(com.hikvision.nvr.dahua.lib.NetSDKLib.LLong, String, int, byte[], int,
 *     IntByReference, int)}和{@link NetSDKLib#CLIENT_SetNewDevConfig(com.hikvision.nvr.dahua.lib.NetSDKLib.LLong, String, int,
 *     byte[], int, IntByReference, IntByReference, int)}
 * @date 2021/4/9
 * @version 1.0
 */
public class CFG_MOTION_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
  ...
  /** 事件响应时间段，时间段获取和设置以此成员为准，忽略 stuEventHandler 中的stuTimeSection */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_TIME_SECTION[] stuTimeSection = new com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_TIME_SECTION[WEEK_DAY_NUM * MAX_REC_TSECT];
  ...
  /** 前端动态检测联动, 事件响应时间段，时间段获取和设置以此成员为准，忽略 stuRemoteEventHandler中的stuTimeSection */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_TIME_SECTION[] stuRemoteTimeSection = new com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_TIME_SECTION[WEEK_DAY_NUM * MAX_REC_TSECT];
    ...
    return "CFG_MOTION_INFO{" +
      ...
      public  CFG_MOTION_INFO(){
            ...
            for(int i=0;i<stuRemoteTimeSection.length;i++){
              stuRemoteTimeSection[i]=new com.hikvision.nvr.dahua.lib.NetSDKLib.CFG_TIME_SECTION();
            }
