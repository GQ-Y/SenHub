 ...
 * 查询到的记录集合
*/
public class NET_OBJECT_FAVORITES_LIBRARY_RECORDS extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 记录收藏的唯一标识
    */
    ...
    */
    public int              nChannel;
    /**
     * 收藏时间,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME stuCollectTime = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME();
    /**
     * 目标类型
    */
