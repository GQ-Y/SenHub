...
*/
public class DEV_EVENT_CROSSFENCEDETECTION_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 围栏上边线信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] stuUpstairsLine = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
     * 围栏下边线顶点数
    */
    public int              nDownstairsLinePointNumber;
    /**
     * 围栏下边线信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] stuDownstairsLine = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
     * 物体运动轨迹顶点数
    */
    public int              nTrackLineNum;
    /**
     * 物体运动轨迹,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] TrackLine = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
    ...
    */
    ...
    public DEV_EVENT_CROSSFENCEDETECTION_INFO() {
        for(int i = 0; i < stuUpstairsLine.length; i++){
            stuUpstairsLine[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
        for(int i = 0; i < stuDownstairsLine.length; i++){
            stuDownstairsLine[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
        for(int i = 0; i < TrackLine.length; i++){
            TrackLine[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
