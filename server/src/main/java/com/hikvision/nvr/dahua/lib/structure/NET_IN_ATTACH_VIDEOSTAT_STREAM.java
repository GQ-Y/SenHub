 ...
 */
public class NET_IN_ATTACH_VIDEOSTAT_STREAM extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 结构体大小
	 */
    public int              dwSize;
	 ...
	 * 统计通道数据回调
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.fVideoStatStreamCallBack cbVideoStatStream;
	/**
	 * 用户数据
	 */
