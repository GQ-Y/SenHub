 ...
 * @date 2021/02/01
 */
public class CFG_LOCATION_CALIBRATE_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 可见光横向视角
	 */
	 ...
	 * 标定点信息
	 */
    public CFG_LOCATION_CALIBRATE_POINT_INFO[] stuPointInfo = new CFG_LOCATION_CALIBRATE_POINT_INFO[com.hikvision.nvr.dahua.lib.constant.SDKStructureFieldLenth.MAX_CALIBRATE_POINT_NUM];
	/**
	 * 标定点个数
	 */
