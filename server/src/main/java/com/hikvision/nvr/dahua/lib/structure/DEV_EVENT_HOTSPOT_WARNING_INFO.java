 ...
 */
public class DEV_EVENT_HOTSPOT_WARNING_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 通道号
	 */
	 ...
	 * 热点的坐标,坐标值 0~8191
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.DH_POINT stuPoint = new com.hikvision.nvr.dahua.lib.NetSDKLib.DH_POINT();
	/**
	 * 热点温度值
	 */
    public float            fHotSpotValue;
	/**
	 * 温度单位(当前配置的温度单位),{@link com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TEMPERATURE_UNIT}
	 */
