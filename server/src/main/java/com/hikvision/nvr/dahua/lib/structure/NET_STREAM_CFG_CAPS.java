...
import com.hikvision.nvr.dahua.lib.enumeration.EM_H264_PROFILE_RANK;
import com.hikvision.nvr.dahua.lib.enumeration.STREAM_RATE_TYPE;
import com.hikvision.nvr.dahua.lib.enumeration.TALK_CODING_TYPE;
 ...
 */
public class NET_STREAM_CFG_CAPS extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
     ...
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO[] stuResolutionTypes = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO[32]; // CFG_MAX_CAPTURE_SIZE_NUM
    /**
     * 不同分辨率下帧率最大值
    ...
    */
    ...
    public NET_STREAM_CFG_CAPS() {
        ...
        for (int i = 0; i < stuResolutionTypes.length; i++) {
            stuResolutionTypes[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO();
        }
