...
*/
public class NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR[] stuNonMotor = new com.hikvision.nvr.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR[8];
    /**
    ...
    */
    ...
    public NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO() {
        for(int i = 0; i < stuNonMotor.length; i++){
            stuNonMotor[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR();
        }
    }
}
