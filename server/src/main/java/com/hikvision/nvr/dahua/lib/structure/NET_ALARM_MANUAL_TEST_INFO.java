 ...
 */
public class NET_ALARM_MANUAL_TEST_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 事件动作 0:脉冲
	 */
    public			int            nAction;
    ...
    */
    ...
    /**
     * 事件发生的UTC时间，不带时区,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME_EX stuRealUTC = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME_EX();
    /**
    ...
    */
	...
	/**
	 保留字节
	 */
    public			byte[]         szReserved = new byte[180-2*com.hikvision.nvr.dahua.lib.NetSDKLib.POINTERSIZE];
