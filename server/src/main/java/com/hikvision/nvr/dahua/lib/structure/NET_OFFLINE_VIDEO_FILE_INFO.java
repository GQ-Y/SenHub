 ...
 * 离线视频文件信息（第三方导入的文件）
*/
public class NET_OFFLINE_VIDEO_FILE_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 结构体大小
    */
    public int              dwSize;
    /**
     * 智能任务启动规则,参见枚举定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.EM_ANALYSE_TASK_START_RULE}
    */
    public int              emStartRule;
    /**
     * 分析规则信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_ANALYSE_RULE}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_ANALYSE_RULE stuRuleInfo = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_ANALYSE_RULE();
    /**
