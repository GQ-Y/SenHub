 ...
 */
public class NET_RECORDFILE_INFOEX extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 录像文件信息
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RECORDFILE_INFO stuRecordFileInfo = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RECORDFILE_INFO();
	/**
	 * 字节对齐
	 */
