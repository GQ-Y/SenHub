 ...
 */
public class NET_IMAGE_RELATION_LIST extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * base64特征值
	 */
	 ...
	 * 目标数据
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_FACE_DATA stuFaceData = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_FACE_DATA();
	/**
	 * 人体属性
	 */
	 ...
	 * 矩形区域
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.DH_POINT[] stuRectPoint = new com.hikvision.nvr.dahua.lib.NetSDKLib.DH_POINT[2];
	/**
	 * 机动车属性
	 */
	...
	public NET_IMAGE_RELATION_LIST() {
		for (int i = 0; i < stuRectPoint.length; i++) {
			stuRectPoint[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.DH_POINT();
		}
	}
}
