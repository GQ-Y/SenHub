 ...
 */
public class DEV_EVENT_FACEBODY_ANALYSE_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    ...
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuBodyImage = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 人体图片信息
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuFaceImage = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 人脸图片信息
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuSceneImage = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 全景图片信息
    ...
    public com.hikvision.nvr.dahua.lib.NetSDKLib.CANDIDATE_INFOEX[] stuCandidate = new  com.hikvision.nvr.dahua.lib.NetSDKLib.CANDIDATE_INFOEX[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MAX_CANDIDATE_NUM]; // 候选人脸列表
    public int              nCandidateNum;                        // 返回的候选人脸个数

    public DEV_EVENT_FACEBODY_ANALYSE_INFO(){
        for(int i=0;i<stuCandidate.length;i++){
            stuCandidate[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.CANDIDATE_INFOEX();
        }
    }
