...
*/
public class NET_IN_ATTACH_HYGROTHERMOGRAPH extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
/** 
/ 此结构体大小,必须赋值
*/
    public			int            dwSize;
...
/ 回调函数,通知温湿度信息
*/
    public			com.hikvision.nvr.dahua.lib.NetSDKLib.fNotifyHygrothermograph cbNotifyHygrothermograph;
/** 
/ 用户自定义参数
*/
