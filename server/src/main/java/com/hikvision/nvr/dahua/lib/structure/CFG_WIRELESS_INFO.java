 ...
 */
public class CFG_WIRELESS_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 2G网络使能
	 */
    public int              bEnable;
	 ...
	 * 拨号时间段
	 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.TIME_SECTION_WEEK_DAY_6[] stuTimeSection = new com.hikvision.nvr.dahua.lib.NetSDKLib.TIME_SECTION_WEEK_DAY_6[7];
	/**
	...
	public CFG_WIRELESS_INFO() {
		for (int i = 0; i < stuTimeSection.length; i++) {
			stuTimeSection[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.TIME_SECTION_WEEK_DAY_6();
		}
	}
}
