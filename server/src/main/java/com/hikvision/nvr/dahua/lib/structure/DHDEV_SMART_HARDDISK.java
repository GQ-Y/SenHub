 ...
 */
public class DHDEV_SMART_HARDDISK extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 硬盘号
	 */
	 ...
	 */
    public DHDEV_SMART_VALUE[] smartValue = new DHDEV_SMART_VALUE[com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_SMART_VALUE_NUM];
