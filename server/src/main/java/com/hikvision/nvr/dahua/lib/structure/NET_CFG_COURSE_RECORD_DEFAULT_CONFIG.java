...
import com.hikvision.nvr.dahua.lib.enumeration.EM_CAN_START_STREAM;
import com.hikvision.nvr.dahua.lib.enumeration.EM_COMPOSIT_CHANNEL_BIND_MODE;
import com.hikvision.nvr.dahua.lib.enumeration.EM_IS_RECORD;

/**
 * @author ： 47040
 * @since ： Created in 2020/9/27 15:16
 */
public class NET_CFG_COURSE_RECORD_DEFAULT_CONFIG extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
