 ...
 */
public class MEDIAFILE_SMART_KITCHEN_CLOTHES_DETECTION_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    public  int             dwSize;                               // 结构体大小
    public 	int             nChannelID;                           // 通道号从0开始,-1表示查询所有通道
    public  com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME stuStartTime;                      // 开始时间
    public 	com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME stuEndTime;                        // 结束时间
    ...
    public  com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME stuStartTimeRealUTC;               // UTC开始时间(标准UTC时间), 与stuEndTimeRealUTC配对使用
    public  com.hikvision.nvr.dahua.lib.NetSDKLib.NET_TIME stuEndTimeRealUTC;                 // UTC结束时间(标准UTC时间), 与stuStartTimeRealUTC配对使用
