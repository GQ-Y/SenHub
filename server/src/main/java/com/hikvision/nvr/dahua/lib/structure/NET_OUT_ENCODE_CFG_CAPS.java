...
import com.hikvision.nvr.dahua.lib.enumeration.GetDevCaps_Type;
import com.hikvision.nvr.dahua.lib.enumeration.REC_TYPE;
import com.hikvision.nvr.dahua.lib.enumeration.SNAP_TYPE;
 ...
 */
public class NET_OUT_ENCODE_CFG_CAPS extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
     ...
     */
    public NET_STREAM_CFG_CAPS[] stuExtraFormatCaps = new NET_STREAM_CFG_CAPS[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_N_ENCODE_AUX];
    /**
     * 抓图码流配置对应能力:如果有多个:
     * 第一个表示普通抓图
     * 第二个表示报警抓图
