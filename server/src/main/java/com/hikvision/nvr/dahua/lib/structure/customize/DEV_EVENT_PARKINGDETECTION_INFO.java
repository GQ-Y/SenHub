package com.hikvision.nvr.dahua.lib.structure.customize;

import com.hikvision.nvr.dahua.lib.NetSDKLib;

import static com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_PATH;
import static com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MAX_DETECT_REGION_NUM;
 ...
 * {@link com.hikvision.nvr.dahua.lib.NetSDKLib.DEV_EVENT_PARKINGDETECTION_INFO}
 *
 * @author 47040
 * @since Created in 2021/5/13 16:57
 */
public class DEV_EVENT_PARKINGDETECTION_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 通道号
     */
     ...
     * 规则检测区域
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] DetectRegion = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[NET_MAX_DETECT_REGION_NUM];
    /**
     * 事件对应文件信息
     */
     ...
     * 扩展信息
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_EXTENSION_INFO stuExtensionInfo;
    /**
     * 车位名称
     */
    ...
    public DEV_EVENT_PARKINGDETECTION_INFO() {
        for (int i = 0; i < DetectRegion.length; ++i) {
            DetectRegion[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
    }
