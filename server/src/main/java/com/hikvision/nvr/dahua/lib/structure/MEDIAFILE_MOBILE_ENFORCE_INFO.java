...
import com.hikvision.nvr.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FILE_TYPE;
import com.hikvision.nvr.dahua.lib.enumeration.EM_MOBILE_ENFORCE_FORMAT;
 ...
 */
public class MEDIAFILE_MOBILE_ENFORCE_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 结构体大小
	 */
    public int              dwSize;
    ...
    */
    ...
    /**
     * GPS信息内容，空间由用户提供,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_GPS_STATUS_INFO}
    */
