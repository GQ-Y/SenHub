 ...
 */
public class NET_IN_THINGS_ATTACH extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小, 调用者必须初始化该字段
     */
    public int              dwSize;
     ...
     * 物模型属性信息回调
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.fThingsCallBack cbThingsInfo;
    /**
     * 用户数据
     */
