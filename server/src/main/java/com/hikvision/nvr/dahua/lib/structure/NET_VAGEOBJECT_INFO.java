 ...
 * @date 2021/10/09
 */
public class NET_VAGEOBJECT_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	 /**
     *  物体ID，每个ID表示一个唯一的物体
     */
     ...
     *  包围盒 绝对坐标
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RECT stuOriginalBoundingBox;
    /**
