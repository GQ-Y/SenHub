 ...
 * @date 2021/02/22
 */
public class MEDIAFILE_ANATOMY_TEMP_DETECT_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	 /**
     *  结构体大小 
     */
    public int              dwSize;
     ...
     *  文件路径 
     */
    public byte[]           szFilePath = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_PATH];
    /**
     *  关联的事件列表,事件类型列表,参见智能分析事件类型
     */
    public int[]            nEventList = new int[com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_IVS_EVENT_NUM];
    /**
     *  事件总数
     */
     ...
     *  人脸图路径
     */
    public byte[]           szFacePicturePath = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_PATH];
    /**
