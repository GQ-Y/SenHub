 ...
 * @date 2020/10/14
 */
public class DEV_EVENT_TRAFFIC_PEDESTRAINRUNREDLIGHT_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 通道号
     */
    ...
    /**
     * 抓图标志(按位),具体见
     * {@link com.hikvision.nvr.dahua.lib.NetSDKLib.NET_RESERVED_COMMON}
     */
    ...
    /**
     * 行人信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MSG_OBJECT}
    */
    ...
    */
     ...
     * 保留字节
     */
    public byte[]           bReserved = new byte[1024-3*com.hikvision.nvr.dahua.lib.NetSDKLib.POINTERSIZE];
    /**
     * 公共信息
     */
