 ...
 * @date 2022/08/10
 */
public class DEV_ENCODER_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     *  前端DVR的IP地址
     */
    public byte[]           szDevIp = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MAX_IPADDR_LEN];
    /**
     *  前端DVR的端口号
     */
     ...
     *  用户名
     */
    public byte[]           szDevUser = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_USER_NAME_LENGTH_EX];
    /**
     *  密码
     */
    public byte[]           szDevPwd = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_USER_PSW_LENGTH_EX];
    /**
     *  通道号
     */
     ...
     */
    public byte[]           szDevIpEx = new byte[com.hikvision.nvr.dahua.lib.NetSDKLib.NET_MAX_IPADDR_OR_DOMAIN_LEN];
    /**
