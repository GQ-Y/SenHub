 ...
 * 拼接屏场景
*/
public class NET_SPLIT_SCENE extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    public int              dwSize;
    /**
     * 拼接屏ID
    ...
    */
    ...
    /**
     * 分割模式,参见枚举定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_SPLIT_MODE}
    */
