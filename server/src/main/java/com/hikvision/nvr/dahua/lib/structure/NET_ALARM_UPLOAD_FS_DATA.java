 ...
 * 目标数据
*/
public class NET_ALARM_UPLOAD_FS_DATA extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 年龄,-1表示该字段数据无效
    */
    ...
    */
    ...
    /**
     * 目标特征数组,与 nFeatureValidNum 结合使用,参见枚举定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.EM_DEV_EVENT_FACEDETECT_FEATURE_TYPE}
    */
    public int[]            emFeature = new int[32];
    /**
     * 性别,参见枚举定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.EM_DEV_EVENT_FACEDETECT_SEX_TYPE}
    */
    public int              emSex;
    /**
