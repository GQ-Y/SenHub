 ...
 * @date 2021/1/27
 */
public class DISKCTRL_PARAM extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
  /** 结构体大小,版本控制用 */
    public int              dwSize;
  ...
  /** 磁盘信息, 由于磁盘顺序可能改变导致下标不准, 用来代替下标 */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_DEV_DISKSTATE stuDisk;
