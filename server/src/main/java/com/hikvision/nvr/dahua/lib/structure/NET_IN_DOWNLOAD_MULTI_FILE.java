...
import com.hikvision.nvr.dahua.lib.enumeration.EM_DOWNLOAD_FILE_TYPE;
import com.hikvision.nvr.dahua.lib.enumeration.EM_SUBCLASSID_TYPE;
 ...
 */
public class NET_IN_DOWNLOAD_MULTI_FILE extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    public int              dwSize;
    /**
     ...
     * 进度回调函数
     */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.fMultiFileDownLoadPosCB cbPosCallBack;
    /**
     * 用户数据
     */
