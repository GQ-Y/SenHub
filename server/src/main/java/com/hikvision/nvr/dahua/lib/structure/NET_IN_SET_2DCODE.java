 ...
 * @author 47081
 * @version 1.0
 * @description {@link NetSDKLib#CLIENT_Set2DCode(com.hikvision.nvr.dahua.lib.NetSDKLib.LLong, Pointer, Pointer, int)}的入参
 * @date 2020/9/10
 */
public class NET_IN_SET_2DCODE extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
