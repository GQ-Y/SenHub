 ...
 * 窗口显示源信息
*/
public class NET_SPLIT_WND_SOURCE extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    public int              dwSize;
    /**
     * 显示源是否有效
    ...
    */
    ...
    /**
     * 远程设备信息,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_REMOTE_DEVICE}
    */
