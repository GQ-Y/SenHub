...
*/
public class DEV_EVENT_PARKINGSPACE_STATUS_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 车厢状态检测区域, 使用相对坐标体系，取值均为0-8191,参见结构体定义 {@link com.netsdk.lib.com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[] stuBoxcarDetectRegion = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT[4];
    /**
     * 车厢状态检测区域个数
    */
    ...
    */
    ...
    public DEV_EVENT_PARKINGSPACE_STATUS_INFO() {
        for(int i = 0; i < stuBoxcarDetectRegion.length; i++){
            stuBoxcarDetectRegion[i] = new com.hikvision.nvr.dahua.lib.NetSDKLib.NET_POINT();
        }
    }
}
