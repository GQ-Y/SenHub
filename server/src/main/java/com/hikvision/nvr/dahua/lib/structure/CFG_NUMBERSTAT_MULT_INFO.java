 ...
 * @date 2021/01/11
 */
public class CFG_NUMBERSTAT_MULT_INFO extends com.hikvision.nvr.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 最大返回规则个数
	 */
	 ...
	 */
    public CFG_SUPPORTED_RULES_INFO[] stuSupportedRules = (CFG_SUPPORTED_RULES_INFO[])new CFG_SUPPORTED_RULES_INFO().toArray(com.hikvision.nvr.dahua.lib.NetSDKLib.MAX_RULE_LIST_SIZE);
