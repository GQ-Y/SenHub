 ...
 * @date 2021/01/11
 */
public class CFG_CAP_SCENE extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 场景名称
	 */
    public byte[]           szSceneName = new byte[com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_PATH];
	/**
	 * 当前规则类型支持的检测物体类型个数
	 */
	 ...
	 * 支持的规则列表
	 */
    public SCENE_SUPPORT_RULE[] stSpportRules = (SCENE_SUPPORT_RULE[])new SCENE_SUPPORT_RULE().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_RULE_LIST_SIZE);
	/**
	 * 是否支持扰动强度设置  
	 */
     ...
     *  标定区域能力信息
     */
    public CFG_CAP_CELIBRATE_AREA[] stCalibrateAreaCap = (CFG_CAP_CELIBRATE_AREA[])new CFG_CAP_CELIBRATE_AREA().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_CALIBRATEAREA_TYPE_NUM);
    /**
     *  是否支持像素计量方式
     */
    public byte             bPixel;
     ...
     *  当前场景下支持的子场景类型
     */
    public MaxSceneSupTypeByteArrInfo[] szSubType = (MaxSceneSupTypeByteArrInfo[])new MaxSceneSupTypeByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_SCENE_SUBTYPE_NUM);
    /**
     *  子场景类型个数
     */
    ...
    */
     ...
     *  保留字节
     */
    public byte[]           byReserved = new byte[1024-2*com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
