 ...
 * 支持大类业务字段
*/
public class NET_PD_SUPPORTED_RULES_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * Normal大类业务列表
    */
    ...
    */
     ...
     * 保留字节
    */
    public byte[]           szReserved = new byte[1012-com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
