 ...
 */
public class DEV_EVENT_FACEBODY_ANALYSE_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    ...
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuBodyImage = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 人体图片信息
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuFaceImage = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 人脸图片信息
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO stuSceneImage = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_EVENT_IMAGE_OFFSET_INFO(); // 全景图片信息
    ...
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFOEX[] stuCandidate = new  com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFOEX[com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MAX_CANDIDATE_NUM]; // 候选人脸列表
    public int              nCandidateNum;                        // 返回的候选人脸个数

    public DEV_EVENT_FACEBODY_ANALYSE_INFO(){
        for(int i=0;i<stuCandidate.length;i++){
            stuCandidate[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFOEX();
        }
    }
