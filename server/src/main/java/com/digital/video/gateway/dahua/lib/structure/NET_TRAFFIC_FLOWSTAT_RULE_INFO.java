...
import com.digital.video.gateway.dahua.lib.NetSDKLib.POINTCOORDINATE;
/**
...
public class NET_TRAFFIC_FLOWSTAT_RULE_INFO extends SdkStructure {
	 ...
	 * 规则检测线
	 */
    public DH_POINT[]       DetectLine = (DH_POINT[])new DH_POINT().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MAX_DETECT_LINE_NUM);
	/**
	 * 车道编号 与场景中的车道号对应
	 */
