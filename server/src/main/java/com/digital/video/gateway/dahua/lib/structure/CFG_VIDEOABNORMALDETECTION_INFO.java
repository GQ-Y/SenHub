 ...
 */
public class CFG_VIDEOABNORMALDETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * null
	 */
	 ...
	 * 事件响应时间段
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[] stuTimeSection = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[7 * 10];
	/**
	 * 检测区顶点数
	 */
