...
import com.digital.video.gateway.dahua.lib.enumeration.GetDevCaps_Type;
import com.digital.video.gateway.dahua.lib.enumeration.REC_TYPE;
import com.digital.video.gateway.dahua.lib.enumeration.SNAP_TYPE;

// NET_N_ENCODE_AUX is defined in NetSDKLib
 ...
 */
public class NET_OUT_ENCODE_CFG_CAPS extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
     ...
     */
    public NET_STREAM_CFG_CAPS[] stuExtraFormatCaps = new NET_STREAM_CFG_CAPS[com.digital.video.gateway.dahua.lib.NetSDKLib.NET_N_ENCODE_AUX];
    /**
     * 抓图码流配置对应能力:如果有多个:
     * 第一个表示普通抓图
     * 第二个表示报警抓图
