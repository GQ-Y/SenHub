 ...
 * IVS算法验证信息
*/
public class NET_IVS_ALGORMITH_VERIFICATION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 负样本内容描述列表
    */
    ...
    */
     ...
     * 保留字节
    */
    public byte[]           szReserved = new byte[248-com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
