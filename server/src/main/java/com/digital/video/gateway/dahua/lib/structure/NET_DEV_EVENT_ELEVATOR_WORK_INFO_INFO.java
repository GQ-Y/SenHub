...
*/
public class NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR[] stuNonMotor = new com.digital.video.gateway.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR[8];
    /**
     * 全景广角图,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO_EX}
    */
    ...
    */
    ...
    public NET_DEV_EVENT_ELEVATOR_WORK_INFO_INFO() {
        for(int i = 0; i < stuNonMotor.length; i++){
            stuNonMotor[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.VA_OBJECT_NONMOTOR();
        }
    }
}
