...
*/
public class NET_ALARM_UPLOAD_FS_RECOGNITION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    ...
    /**
     * 检测到的物体,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
    ...
    /**
     * 当前目标匹配到的候选对象信息,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFO}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFO[] stuCandidates = new com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFO[50];
    /**
     * 候选对象信息有效个数
    */
    ...
    */
    ...
    public NET_ALARM_UPLOAD_FS_RECOGNITION_INFO() {
        for(int i = 0; i < stuCandidates.length; i++){
            stuCandidates[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CANDIDATE_INFO();
        }
    }
}
