 ...
 */
public class MEDIAFILE_SMART_KITCHEN_CLOTHES_DETECTION_PARAM extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    public int              dwSize;                               // 结构体大小
    public 	int             nChannelID;                           // 通道号从0开始,-1表示查询所有通道
    public 	com.digital.video.gateway.dahua.lib.NetSDKLib.NET_TIME stuBeginTime;                      // 开始时间
