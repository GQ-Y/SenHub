 ...
 */
public class NET_RECORDFILE_INFOEX extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 录像文件信息
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RECORDFILE_INFO stuRecordFileInfo = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RECORDFILE_INFO();
	/**
	 * 字节对齐
	 */
