...
import com.digital.video.gateway.dahua.lib.enumeration.EM_H264_PROFILE_RANK;
import com.digital.video.gateway.dahua.lib.enumeration.STREAM_RATE_TYPE;
import com.digital.video.gateway.dahua.lib.enumeration.TALK_CODING_TYPE;

// Constants defined inline (CFG_MAX_AUDIO_ENCODE_TYPE = 16, CFG_MAX_CAPTURE_SIZE_NUM = 32, CFG_MAX_COMPRESSION_TYPES_NUM = 16)
 ...
 */
public class NET_STREAM_CFG_CAPS extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 结构体大小
     */
    public int              dwSize;
     ...
     */
    public int[]            nAudioCompressionTypes = new int[16]; // CFG_MAX_AUDIO_ENCODE_TYPE
    /**
     * 音频压缩格式个数
     ...
     */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO[] stuResolutionTypes = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO[32]; // CFG_MAX_CAPTURE_SIZE_NUM
    /**
     * 不同分辨率下帧率最大值
     ...
     * 有效长度由 {@link #nResolutionTypeNum} 决定
     */
    public int[]            nResolutionFPSMax = new int[32]; // CFG_MAX_CAPTURE_SIZE_NUM
    /**
     ...
     */
    public NET_RESOLUTION_INFO_ARRAY[] stuIndivResolutionTypes = new NET_RESOLUTION_INFO_ARRAY[16]; // CFG_MAX_COMPRESSION_TYPES_NUM
    /**
     ...
     */
    public int[]            nIndivResolutionNums = new int[16]; // CFG_MAX_COMPRESSION_TYPES_NUM
    /**
     * 码流分辨率限制个数
    */
    ...
    */
    ...
    public NET_STREAM_CFG_CAPS() {
        ...
        for (int i = 0; i < stuResolutionTypes.length; i++) {
            stuResolutionTypes[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RESOLUTION_INFO();
        }
