...
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_FACE_DATA;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_FEATURE_VECTOR;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_GPS_INFO;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_PASSERBY_INFO;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_PIC_INFO;
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_TIME_EX;
import com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO;
import com.digital.video.gateway.dahua.lib.structure.NET_CUSTOM_PROJECTS_INFO;
import com.digital.video.gateway.dahua.lib.structure.NET_IMAGE_INFO_EX2;
import com.digital.video.gateway.dahua.lib.structure.NET_MSG_OBJECT_SUPPLEMENT;
 ...
 * @date 2022/05/23
 */
public class DEV_EVENT_FACERECOGNITION_INFO_V1 extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    ...
    public byte[]           szSnapDevAddress = new byte[com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_PATH]; // 抓拍当前人脸的设备地址,如：滨康路37号
    ...
    public byte[]           szUID = new byte[com.digital.video.gateway.dahua.lib.NetSDKLib.NET_COMMON_STRING_32]; // 抓拍人员写入数据库的唯一标识符
