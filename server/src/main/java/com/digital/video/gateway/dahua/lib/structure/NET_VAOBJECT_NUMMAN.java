...
import com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RECT;
...
public class NET_VAOBJECT_NUMMAN extends SdkStructure {
    ...
    */
    ...
    public byte[]           byReserved = new byte[120-3*com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE]; // 预留字节
}
