...
import static com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_REC_TSECT;
import static com.digital.video.gateway.dahua.lib.constant.SDKStructureFieldLenth.MAX_MOTION_ROW;
import static com.digital.video.gateway.dahua.lib.constant.SDKStructureFieldLenth.WEEK_DAY_NUM;
import static com.digital.video.gateway.dahua.lib.constant.SDKStructureFieldLenth.MAX_MOTION_WINDOW;

/**
 * @author 47081
 * @description 动态监测报警配置,对应接口 {@link
 *     com.netsdk.lib.NetSDKLib#CLIENT_GetNewDevConfig(com.digital.video.gateway.dahua.lib.NetSDKLib.LLong, String, int, byte[], int,
 *     IntByReference, int)}和{@link NetSDKLib#CLIENT_SetNewDevConfig(com.digital.video.gateway.dahua.lib.NetSDKLib.LLong, String, int,
 *     byte[], int, IntByReference, IntByReference, int)}
 * @date 2021/4/9
 * @version 1.0
 */
public class CFG_MOTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
  ...
  /** 事件响应时间段，时间段获取和设置以此成员为准，忽略 stuEventHandler 中的stuTimeSection */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[] stuTimeSection = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[WEEK_DAY_NUM * MAX_REC_TSECT];
  ...
  /** 前端动态检测联动 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_ALARM_MSG_HANDLE stuRemoteEventHandler = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_ALARM_MSG_HANDLE();
  /** 前端动态检测联动, 事件响应时间段，时间段获取和设置以此成员为准，忽略 stuRemoteEventHandler中的stuTimeSection */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[] stuRemoteTimeSection = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION[WEEK_DAY_NUM * MAX_REC_TSECT];
    ...
    return "CFG_MOTION_INFO{" +
      ...
      public  CFG_MOTION_INFO(){
            ...
            for(int i=0;i<stuRemoteTimeSection.length;i++){
              stuRemoteTimeSection[i]=new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_TIME_SECTION();
            }
