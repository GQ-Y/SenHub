...
*/
public class DEV_EVENT_CROSSFENCEDETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号
    */
    ...
    */
    public int              nEventID;
    /**
     * 检测到的物体,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT}
    */
    ...
    */
    ...
    /**
     * 围栏上边线信息,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[] stuUpstairsLine = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
     * 围栏下边线顶点数
    */
    public int              nDownstairsLinePointNumber;
    /**
     * 围栏下边线信息,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[] stuDownstairsLine = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
     * 物体运动轨迹顶点数
    */
    public int              nTrackLineNum;
    /**
     * 物体运动轨迹,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[] TrackLine = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT[20];
    /**
    ...
    */
    ...
    public DEV_EVENT_CROSSFENCEDETECTION_INFO() {
        for(int i = 0; i < stuUpstairsLine.length; i++){
            stuUpstairsLine[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT();
        }
        for(int i = 0; i < stuDownstairsLine.length; i++){
            stuDownstairsLine[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT();
        }
        for(int i = 0; i < TrackLine.length; i++){
            TrackLine[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_POINT();
        }
