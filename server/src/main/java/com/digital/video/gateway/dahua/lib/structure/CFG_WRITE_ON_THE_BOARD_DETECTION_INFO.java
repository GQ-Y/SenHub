...
*/
public class CFG_WRITE_ON_THE_BOARD_DETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 警戒区， 多边形类型，多边形中每个端点的坐标归一化到[0,8192)区间。,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE[] stuDetectRegion = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE[20];
    /**
    ...
    */
    ...
    /**
     * 检测区,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON[] stuDesignedRegion = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON[2];
    /**
     * 保留字节
    */
    ...
    public CFG_WRITE_ON_THE_BOARD_DETECTION_INFO() {
        ...
        for(int i = 0; i < stuDetectRegion.length; i++){
            stuDetectRegion[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE();
        }
        for(int i = 0; i < stuDesignedRegion.length; i++){
            stuDesignedRegion[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON();
        }
    }
}
