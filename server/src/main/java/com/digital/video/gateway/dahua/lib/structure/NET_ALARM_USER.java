 ...
 */
public class NET_ALARM_USER extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 用户编号
	 */
	 ...
	 * 保留字节
	 */
    public byte[]           byReserved = new byte[256 - com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
}
