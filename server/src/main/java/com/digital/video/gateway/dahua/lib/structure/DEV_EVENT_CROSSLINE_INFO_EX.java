 ...
 */
public class DEV_EVENT_CROSSLINE_INFO_EX extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/** 
	...
	*/
	 ...
	 * 检测到的物体
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX stuObject = new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX();
	/**
	 * 事件对应文件信息
	 */
	 ...
	 * 规则检测线
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[] DetectLine = (com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[]) new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT().toArray(20);
	/**
	 * 规则检测线顶点数
	 */
	 ...
	 * 物体运动轨迹
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[] TrackLine = (com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[]) new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT().toArray(20);
	/**
	 * 物体运动轨迹顶点数
	 */
