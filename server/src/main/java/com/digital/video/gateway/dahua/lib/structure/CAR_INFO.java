 ...
 * @date 2021/09/01
 */
public class CAR_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
     *  机动车电子标识序列号
     */
    ...
    /**
     *  车辆类型,参考com.digital.video.gateway.dahua.lib.NetSDKLib.EM_CAR_TYPE
     */
