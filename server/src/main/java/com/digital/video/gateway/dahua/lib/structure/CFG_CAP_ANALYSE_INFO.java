 ...
 * @date 2021/01/08
 */
public class CFG_CAP_ANALYSE_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 支持的场景个数
	 */
	 ...
	 * 支持的场景列表
	 */
    public MaxNameByteArrInfo[] szSceneName = (MaxNameByteArrInfo[])new MaxNameByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_SCENE_LIST_SIZE);
	/**
	 * 每通道支持最大分析模块数
	 */
	 ...
	 * 支持的检测物体类型列表
	 */
    public MaxNameByteArrInfo[] szObjectTypeName = (MaxNameByteArrInfo[])new MaxNameByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_OBJECT_LIST_SIZE);
	/**
	 * 每通道支持最大规则条数
	 */
	 ...
	 */
    public int[]            dwRulesType = new int[com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_RULE_LIST_SIZE];
	/**
	 * 支持的最大标尺个数
	 */
	 ...
	 * 支持的特殊检测区属性
	 */
    public int[]            nSupportedSpecialDetectPropertys = new int[com.digital.video.gateway.dahua.lib.NetSDKLib.EM_SEPCIALREGION_PROPERTY_TYPE.EM_SEPCIALREGION_PROPERTY_TYPE_NUM];
	/**
	 ...
	 * 支持的场景组合项列表
	 */
    public CFG_SUPPORTED_COMP[] stuSupportedComp = (CFG_SUPPORTED_COMP[])new CFG_SUPPORTED_COMP().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_SUPPORTED_COMP_SIZE);
	/**
	 ...
	 * 实际返回客流量统计场景PD个数
	 */
    public CFG_NUMBERSTAT_MULT_INFO[] stuNumberStatMult = (CFG_NUMBERSTAT_MULT_INFO[])new CFG_NUMBERSTAT_MULT_INFO().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_NUMBER_STAT_MAULT_NUM);
	/**
