...
*/
public class DEV_EVENT_TRAFFIC_CAR_MEASUREMENT_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
/** 
通道号
*/
...
卡片信息
*/
    public com.digital.video.gateway.dahua.lib.NetSDKLib.EVENT_CARD_INFO stuCardInfo = new com.digital.video.gateway.dahua.lib.NetSDKLib.EVENT_CARD_INFO();
/** 
...
/** 
开闸状态 {@link com.digital.video.gateway.dahua.lib.NetSDKLib.EM_OPEN_STROBE_STATE}
*/
    public			int            emOpenStrobeState;
/** 
抓拍车的位置 {@link com.digital.video.gateway.dahua.lib.NetSDKLib.EM_VEHICLE_DIRECTION}
*/
    public			int            emVehicleDirection;
/** 
主驾驶座位安全带状态 {@link com.digital.video.gateway.dahua.lib.NetSDKLib.NET_SAFEBELT_STATE}
*/
    public			int            emMainSeat;
/** 
副驶座位安全带状态 {@link com.digital.video.gateway.dahua.lib.NetSDKLib.NET_SAFEBELT_STATE}
*/
...
*/
    ...
    */
    ...
    /**
     * 车身信息扩展,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MSG_OBJECT_EX2}
    */
    public Pointer          pstuVehicleEx2;
/** 
保留字节
*/
    public			byte[]         byResersed = new byte[1020-com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
