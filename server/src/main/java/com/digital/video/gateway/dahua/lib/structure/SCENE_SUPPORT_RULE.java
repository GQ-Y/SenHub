 ...
 * @date 2021/01/11
 */
public class SCENE_SUPPORT_RULE extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 规则类型
	 */
	 ...
	 * 支持的检测物体动作列表
	 */
    public MaxNameByteArrInfo[] szSupportedActions = (MaxNameByteArrInfo[]) new MaxNameByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_ACTION_LIST_SIZE);
	/**
	 * 支持的检测类型个数
	 */
	 ...
	 * 支持的检测类型列表
	 */
    public MaxNameByteArrInfo[] szSupportedDetectTypes = (MaxNameByteArrInfo[]) new MaxNameByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_ACTION_LIST_SIZE);
	/**
	 * 支持的目标检测类型个数
	 */
	 ...
	 * 支持的目标检测类型列表
	 */
    public MaxNameByteArrInfo[] szSupportFaceTypes = (MaxNameByteArrInfo[]) new MaxNameByteArrInfo().toArray(com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_HUMANFACE_LIST_SIZE);
	/**
	 * 是否支持触发报警位置
	 */
	 ...
	 */
    public int[]            emFeatureList = new int[com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_FEATURE_LIST_SIZE];
	/**
	 * 支持规则的最大个数
	 */
