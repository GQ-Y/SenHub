...
*/
public class CFG_IVS_HEATMAP_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 规则名称,不同规则不能重名
    */
    ...
    */
    ...
    /**
     * 警戒区,多边形类型，多边形中每个顶点的坐标归一化到[0,8192)区间,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON}
    */
    ...
    */
    ...
    /**
     * 规则特定的尺寸过滤器,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_SIZEFILTER_INFO}
    */
