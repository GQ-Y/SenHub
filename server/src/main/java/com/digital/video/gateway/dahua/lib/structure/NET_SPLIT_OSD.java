 ...
 */
public class NET_SPLIT_OSD extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    public int              dwSize;
	/**
	 * 使能
	 */
	 ...
	 * 前景区域
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.DH_RECT stuFrontRect = new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_RECT();
	/**
	 * 背景区域
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.DH_RECT stuBackRect = new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_RECT();
	/**
	 * 是否滚动显示, 只对文本有效
	 */
    public int              bRoll;
