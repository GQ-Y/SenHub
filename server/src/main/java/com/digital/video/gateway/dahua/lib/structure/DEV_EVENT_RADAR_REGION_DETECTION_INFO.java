...
*/
public class DEV_EVENT_RADAR_REGION_DETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
/** 
通道号
*/
...
全景广角图（扩展为10张）
*/
    public			com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO_EX[] stuSceneImageEx = new com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO_EX[10];
/** 
全景广角图个数
*/
...
public DEV_EVENT_RADAR_REGION_DETECTION_INFO(){
		...
		for(int i=0;i<stuSceneImageEx.length;i++){
			stuSceneImageEx[i]=new com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO_EX();
			}
}
}
