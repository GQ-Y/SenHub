...
*/
public class NET_DEV_EVENT_RAILING_PASS_DETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure
{
    /**
     * 通道号,从0开始
    */
    ...
    */
    public int              nRuleID;
    /**
     * 事件发生的时间,标准的（不带时区偏差的）UTC时间,参见结构体定义 {@link com.netsdk.lib.com.digital.video.gateway.dahua.lib.NetSDKLib.NET_TIME_EX}
    */
