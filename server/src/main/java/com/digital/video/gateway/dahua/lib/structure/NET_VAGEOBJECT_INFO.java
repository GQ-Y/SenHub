 ...
 * @date 2021/10/09
 */
public class NET_VAGEOBJECT_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	 /**
     *  物体ID，每个ID表示一个唯一的物体
     */
     ...
     *  包围盒 绝对坐标
     */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_RECT stuOriginalBoundingBox;
    /**
