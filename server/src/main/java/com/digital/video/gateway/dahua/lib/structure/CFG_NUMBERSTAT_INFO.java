 ...
 */
public class CFG_NUMBERSTAT_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 规则名称,不同规则不能重名
	 */
	 ...
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON[] stDirection = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON[2];
	/**
	 * 记录周期，单位：分钟，1~10
	 */
	 ...
	 * 离开检测线坐标
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE[] stuDetectLine = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE[20];
	/**
	 * 停留超时时间
	 */
    ...
    */
	...
	public CFG_NUMBERSTAT_INFO() {
		...
		for (int i = 0; i < stDirection.length; i++) {
			stDirection[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYGON();
		}
		for (int i = 0; i < stuDetectLine.length; i++) {
			stuDetectLine[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.CFG_POLYLINE();
		}
		for (int i = 0; i < stuRemoteTimeSection.length; i++) {
			stuRemoteTimeSection[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.TIME_SECTION_WEEK_DAY_10();
		}
	}
}
