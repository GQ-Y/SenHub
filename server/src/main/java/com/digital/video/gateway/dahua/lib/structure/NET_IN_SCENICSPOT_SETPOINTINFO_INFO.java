...
import com.digital.video.gateway.dahua.lib.enumeration.NET_EM_SHAPE_TYPE;

import static com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_COMMON_STRING_64;
import static com.digital.video.gateway.dahua.lib.NetSDKLib.NET_MAX_POLYGON_NUM;
 ...
 */
public class NET_IN_SCENICSPOT_SETPOINTINFO_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 结构体大小
	 */
    public int              dwSize;
	 ...
	 * 景物的轮廓,每个点依次表示轮廓顶点坐标
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[] stuPolygon = new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT[NET_MAX_POLYGON_NUM];
	/**
	...
	public NET_IN_SCENICSPOT_SETPOINTINFO_INFO() {
		...
		for (int i = 0; i < stuPolygon.length; i++) {
			stuPolygon[i] = new com.digital.video.gateway.dahua.lib.NetSDKLib.DH_POINT();
		}
	}
}
