 ...
 */
public class NET_IN_ATTACH_VIDEOSTAT_STREAM extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
	/**
	 * 结构体大小
	 */
    public int              dwSize;
	 ...
	 * 统计通道数据回调
	 */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.fVideoStatStreamCallBack cbVideoStatStream;
	/**
	 * 用户数据
	 */
