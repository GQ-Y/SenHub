...
import static com.digital.video.gateway.dahua.lib.NetSDKLib.MAX_INSIDEOBJECT_NUM;
 ...
 */
public class DEV_EVENT_XRAY_DETECTION_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
    /**
     * 通道号
     */
     ...
     * 客户自定义信息, X光机专用
     */
    public com.digital.video.gateway.dahua.lib.NetSDKLib.NET_XRAY_CUSTOM_INFO stuViewCustomInfo[] = (com.digital.video.gateway.dahua.lib.NetSDKLib.NET_XRAY_CUSTOM_INFO[]) new com.digital.video.gateway.dahua.lib.NetSDKLib.NET_XRAY_CUSTOM_INFO().toArray(4);
    /**
     * 包裹标识, 用来唯一标识一个包裹
     */
    ...
    */
     ...
     * 保留字节,留待扩展
     */
    public byte             byReserved[] = new byte[192-com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE*4];
