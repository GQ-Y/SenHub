...
*/
public class DEV_EVENT_ELECTRICFAULTDETECT_INFO extends com.digital.video.gateway.dahua.lib.NetSDKLib.SdkStructure {
/** 
...
大图
*/
    public com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO stuSceneImageInfo = new com.digital.video.gateway.dahua.lib.NetSDKLib.SCENE_IMAGE_INFO();
/** 
绝缘子检测结果
*/
...
*/
    ...
    /**
     * 穿戴检测结果结果,参见结构体定义 {@link com.netsdk.lib.structure.NET_WEAR_DETECT}
    */
    ...
    */
    ...
    /**
     * 视频流缺陷检测到的目标信息,参见结构体定义 {@link com.netsdk.lib.structure.NET_ELECTRIC_FAULT_OBJECTS_INFO}
    */
    public Pointer          pstuObjects;
    /**
     * 检测结果扩展信息 内存由SDK内部申请释放,参见结构体定义 {@link com.netsdk.lib.structure.NET_EXTEND_DETECT_EX}
    */
    public Pointer          pstuExtendDetectEx;
/** 
预留字段
*/
    public			byte[]         bReserved = new byte[376-2*com.digital.video.gateway.dahua.lib.NetSDKLib.POINTERSIZE];
